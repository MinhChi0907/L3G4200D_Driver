 ...
 * *******************************************************
*/
#ifndef __L3G4200D_LL_H
#define __L3G4200D_LL_H
...
#define USE_SPI_FULL_DUPLEX_PROTOCOL_FOR_THIS_APPLICATION
#define USE_I2C_PROTOCOL_FOR_THIS_APPLICATION
 ...
 * @brief Sensor struct
 */
#include "stm32f1xx_ll_spi.h"   /* Need for SPI*/
...
/**
 * @brief This APIs to help user to control device use SPI protocol
 */
