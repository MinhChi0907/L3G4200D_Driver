...
#ifndef __L3G4200D_HAL_I2C_H
#define __L3G4200D_HAL_I2C_H

/**
 * Change this header file if you use another STM32 MCU, or another driver
 */
#include "stm32f1xx_hal.h"   /* Need for I2C */
#include <stdint.h>
...
//        .CTRL_REG1_Bits.pwr_mode = PWR_DOWN_MODE,
